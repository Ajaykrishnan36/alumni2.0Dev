...
import ResourcesIcon from '@salesforce/resourceUrl/ResourceIcon';


// Active icons (gradient/highlight versions)
import HomeIconActive from '@salesforce/resourceUrl/HomeIcon';
import CalendarIconActive from '@salesforce/resourceUrl/CalendarIconBottomNav';
import CampusLifeIconActive from '@salesforce/resourceUrl/CampusLifeIcon';
import ResourcesIconActive from '@salesforce/resourceUrl/ResourceIcon';

export default class KenBottomNavigationMobile extends NavigationMixin(LightningElement) {
    @track activeTab = '';
