...
export default class KenEventRegisterStepper extends LightningElement {
    @api currentStep = 1;
    ...
    get stepperItems() {
        const steps = [
            { number: 1, label: 'Participants', completed: this.isStep1Completed },
            { number: 2, label: 'Select Sessions', completed: this.isStep2Completed },
    ...
    get progressFillStyle() {
        const progress = Math.min(100, ((this.currentStep - 1) / 2) * 100);
