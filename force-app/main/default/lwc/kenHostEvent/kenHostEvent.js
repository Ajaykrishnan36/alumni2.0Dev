...
import bgimg from '@salesforce/resourceUrl/EventIcon';
import { NavigationMixin } from 'lightning/navigation';
import basePath from '@salesforce/community/basePath';
import FORM_FACTOR from '@salesforce/client/formFactor';
import EmptyStateEventImage from '@salesforce/resourceUrl/EmptyStateEventImage';
import { getPortalConfigs as getPrimaryColor } from 'c/kenThemeConfig';
export default class KenHostEvent extends NavigationMixin(LightningElement) {
    @track bgimage = bgimg;
    @track screenWidth = window.innerWidth;
    @track eventRequests = [];
    @track emptyStateEventImage = EmptyStateEventImage;
    ...
    connectedCallback() {
        ...
        getPrimaryColor().then(color => {
            ...
            this.showComponent = color?.showHostEvent === true;
        }).catch(() => {
